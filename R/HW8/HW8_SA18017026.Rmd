...
Generate 1000 samples from distribution $0.3N(0,1)+0.7N(1,0.32)$,  draw one figure with different estimated derivative density functions with different bandwidth $h$ where $h$ is given by \emph{kedd}.
